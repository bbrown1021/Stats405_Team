...
SELECT game.date
        ...
        , players.timeOnIce
        , players.goals
        , CASE WHEN players.team = 'Montréal Canadiens' THEN 'Montreal Canadiens'
			else players.team end as team
		, CASE WHEN game.VT = 'Montréal Canadiens' THEN 'Montreal Canadiens'
			else game.VT end as VT
		, CASE WHEN game.HT = 'Montréal Canadiens' THEN 'Montreal Canadiens'
