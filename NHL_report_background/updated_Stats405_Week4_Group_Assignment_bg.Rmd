...
The third tables show the highest scoring players in the games that had the top two officials. Both tables show the date of the game, highest scoring players first and last names, visiting and home teams, as well as the number of goals scored. Almost all players scored a total of four goals with the exception of Patrik Laine, who scored five while Kozari officiated. 
...
if( opts_knit$get("rmarkdown.pandoc.to") %in% "latex" ) {
  ...
  xcaption3 <- paste0("Highest scoring Players in the games which Matt MacPherson officiated.")
  x.big <- suppressWarnings(xtable(df_MM))
